...
const messages = {
  en: {
    ...
    editTaskForm: "Edit task",
    searchingTaskForm: "Searching task",
    replenishmentBalanceForm: "Replenishment balance",
  ...
  ua: {
    ...
    authorizationForm: "Авторизація",
    editProfileForm: "Редагування профілю",
    createTaskForm: "Створення задачі",
    editTaskForm: "Редагування задачі",
    searchingTaskForm: "Пошук задачі",
    replenishmentBalanceForm: "Поповнення балансу",
    ...
    SignIn: "Увійти",
    SignInAiuto: "Увійти в Aiuto",
    CreateAccount: "Створити акаунт",
    NewHere: "Новий тут?",
    ForgotPassword: "Забув пароль ?",
    EnterEmail: "Внесіть вашу електронну адресу, щоб замінити пароль.",
    YourEmail: "Електронна адреса",
    CancelIt: "Відміна",
    AlreadyHave: "Вже маєте акаунт ?",
    Use8OrMore:
      "Використовуй 8 або більше символів в суміші букв, цифр & символів.",
    IAgree: "Я згоден &",
    TermsCond: "Положення та умови",
  ...
  ru: {
    ...
    authorizationForm: "Авторизация",
    editProfileForm: "Редактирование профиля",
    createTaskForm: "Создание задачи",
    editTaskForm: "Редактирование задачи",
    searchingTaskForm: "Поиск задачи",
    replenishmentBalanceForm: "Пополнение баланса",
    ...
    SignIn: "Войти",
    SignInAiuto: "Войти в Aiuto",
    CreateAccount: "Создать аккаунт",
    NewHere: "Новый здесь?",
    ForgotPassword: "Забыл пароль ?",
    EnterEmail: "Внесите вашу електронну адресу, щоб замінити пароль.",
    YourEmail: "Электронный адрес",
    CancelIt: "Отменить",
    AlreadyHave: "Уже имеете аккаунт ?",
    Use8OrMore:
      "Используй 8 или больше символов в смеси букв, цифр & символов.",
    IAgree: "Я согласен &",
    TermsCond: "Положения и условия",
